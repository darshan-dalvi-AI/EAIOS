...
start "K-OS Backend" /d "%~dp0backend" cmd /k "python -m pip install -r requirements.txt && python -m app.seed && python -m uvicorn app.main:app --host 127.0.0.1 --port 8000"
